...
export default function AjouterActu({ route  }) {
    ...
    const handleAjouter = async () => {
        ...
        socket1.emit("ajouterActu", {
            id: 'A' + timestamp + loginState.user, 
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ 
                ...
                <Title style={{fontSize: 30, color:'#222222', fontWeight:'bold'}}>Nouvelle actualité</Title>
            </View>
            <ScrollView>
