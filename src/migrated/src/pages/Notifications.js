    ...
    return (
        <View style={{ flex: 1,}}>
            ...
            {/* <View style={{ 
                ...
                <Title style={{fontSize: 30, color:'#222222', fontWeight:'bold'}}>Notifications</Title>
            </View> */}
            ...
            <View style={{ 
                ...
                <Text style={{fontSize: 16, marginBottom: 150}}>Pas de notifications</Text>
            </View>
        </View>
    );
}