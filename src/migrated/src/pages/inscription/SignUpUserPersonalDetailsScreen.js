...
export function SignUpUserPersonalDetailsScreen(props) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} 
            ...
            {/* <View style={{ 
                ...
                <Title style={{fontSize: 30, color:'#222222', fontWeight:'bold'}}>Informations</Title>
            </View> */}
            ...
            <View style={{ 
                ...
                <Text style={{fontSize: 16, color:'#222222'}}>Entrez votre nom et celle de votre ville. Cette étape peut être complétée ultérieurement.</Text>
            </View>
            ...
            <View style={{ 
                    ...
                    <TouchableOpacity title="my location" mode='contained'
                        onPress={() => {console.log(props.route.params); props.navigation.navigate('SignUpUserPasswordDetails', {tel: props.route.params.tel, nom: nom, ville: ville, username: props.route.params.username})} }
                        style={{ 
                            width: 150,
                            height: 45, 
