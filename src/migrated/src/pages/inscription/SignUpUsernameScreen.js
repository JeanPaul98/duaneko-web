...
export function SignUpUsernameScreen(props) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} 
            ...
            {/* <View style={{ 
                ...
                <Title style={{fontSize: 30, color:'#222222', fontWeight:'bold'}}>Nom d'utilisateur</Title>
            </View> */}
            ...
            <View style={{ 
                ...
                <Text style={{fontSize: 16, color:'#222222'}}>Veuillez entrer un nom d'utilisateur.</Text>
            </View>
            ...
            <View style={{ 
                    ...
                    <TouchableOpacity title="my location" mode='contained'
                        onPress={() => {console.log(nom); props.navigation.navigate('SignUpUserPersonalDetails', {tel: props.route.params.tel, username: nom});} }
                        style={{ 
                            width: 150,
                            height: 45, 
