                                    ...
                                    <tbody>
                                        @foreach ($ramassages as $ramassage)
                                            <tr>
                                                ...
                                                <td style="white-space: nowrap;">{{ $ramassage->date_de_ramassage }}</td>
                                                <td style="white-space: nowrap;">{{ $ramassage->heure_de_ramassage }}</td>
                                                <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $ramassage->description }}">
                                                    {{ $ramassage->description }}
                                                </td>
